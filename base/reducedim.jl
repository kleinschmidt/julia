...
reducedim_init(f, op::typeof(max), A, region) = reducedim_initarray0(A, region, f, maximum)
reducedim_init(f, op::typeof(min), A, region) = reducedim_initarray0(A, region, f, minimum)
